          ...
          <div className="md:col-span-4">
            ...
            <div className="flex space-x-3">
              <a 
                ...
                className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent transition-colors"
              >
              ...
              <a
                ...
                className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent transition-colors"
              >
                <svg className="w-3 h-3" viewBox="0 0 50 50" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                ...
                className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent transition-colors"
              >
                <svg className="w-3 h-3" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
